...
type MMN_CPU
  as FBSBOOLEAN  fpu,tsc,cmov,mmx,mmx2,sse,sse2,n3D,n3D2
  as double                start
  as integer                      mhz
...
private _
function _IsCPUID() as FBSBOOLEAN 'CPUID command aviable
...
private _
function _IsFPU() as FBSBOOLEAN 'FPU aviable
  dim as ushort tmp
  tmp = &HFFFF
...
function IsFPU()  as FBSBOOLEAN export
  return me.fpu
end function 
function IsTSC()  as FBSBOOLEAN export
  return me.tsc
end function 
function IsCMOV() as FBSBOOLEAN export
  return me.cmov
end function 
function IsMMX()  as FBSBOOLEAN export
  return me.mmx
end function 
function IsMMX2() as FBSBOOLEAN export
  return me.mmx
end function 
function IsSSE()  as FBSBOOLEAN export
  return me.sse
end function 
function IsSSE2() as FBSBOOLEAN export
  return me.sse2
end function 
function Is3DNOW() as FBSBOOLEAN export
  return me.n3d
end function 
function Is3DNOW2() as FBSBOOLEAN export
  return me.n3d2
end function 
